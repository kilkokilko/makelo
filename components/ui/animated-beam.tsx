...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  // Each beam gets its own slightly different speed so the bundle never
  // pulses in lockstep — picked once, not re-rolled on every render.
